#!/usr/bin/env python3
"""Compatibility shim: `python finetune.py` still works from a source checkout.

Everything moved into the installed `hidra` package (see pyproject.toml); the equivalent
entry point is `hidra-finetune`. This file only exists so the commands in the README and in
...
from hidra.finetune import main  # noqa: E402
