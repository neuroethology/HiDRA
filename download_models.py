#!/usr/bin/env python3
"""Compatibility shim: `python download_models.py` still works from a source checkout.

Everything moved into the installed `hidra` package (see pyproject.toml); the equivalent
entry point is `hidra-download-models`. This file only exists so the commands in the README and in
...
from hidra.download_models import main  # noqa: E402
